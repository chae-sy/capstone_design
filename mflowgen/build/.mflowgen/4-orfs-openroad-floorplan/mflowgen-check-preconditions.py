...
#-------------------------------------------------------------------------
# Generated: /home/sychae/cuda-vscode/mflowgen/mflowgen/assertions/assertion_helpers.py
...
def test_1_():
    assert File( 'inputs/orfs-docker-image.tar' )

def test_2_():
    assert File( 'inputs/flow-checkpoint.tar.gz' )


def main():

  print()
  print( GREEN + '    > Checking preconditions for node "orfs-openroad-floorplan"' + END )
  print()
