...
module layer_pipeline #(
    ...
    //Memory A 
    output  wire [14:0] memA_addr_o,
    output  wire        memA_wenb_o,
    output  wire        memA_cenb_o,
    //Memory B
    output  wire [14:0] memB_addr_o,
    ...
    reg     [14:0]          mem_rd_addr, mem_rd_addr_n;
    ...
    reg     [14:0]          mem_wr_addr, mem_wr_addr_n;
    reg     [14:0]          mem_wr_pad_addr, mem_wr_pad_addr_n;
    ...
    reg     [14:0]          start_point; 
    reg     [14:0]          start_weight;                    
